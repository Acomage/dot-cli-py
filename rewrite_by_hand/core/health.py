...
class Checker:
    ...
    def check(self) -> HealthStatus:
        ...
        # If the repo is healthy, it should contain a .git directory, a conflict directory witch contains a system directory and a user directory, a system directory, a user directory, a .gitignore file, a config.json file, a local_config.json file, and a README.md file
        if ".git" not in os.listdir(REPOPATH):
            return HealthStatus.Repo_Dir_Exist_And_Our_Repo_But_Not_Healthy
        if "conflict" not in os.listdir(REPOPATH):
            return HealthStatus.Repo_Dir_Exist_And_Our_Repo_But_Not_Healthy
        ...
        if "README.md" not in os.listdir(REPOPATH):
            return HealthStatus.Repo_Dir_Exist_And_Our_Repo_But_Not_Healthy
        # TODO:cheak if the repo structure is consis with config.json
